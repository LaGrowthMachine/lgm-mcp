...
To read or analyze a LinkedIn post from its URL (e.g. "Que dit ce post ?", "How did this LinkedIn post perform?", "Résume ce post"), call get_linkedin_post with the pasted URL — it returns the text, author and reaction counts.
